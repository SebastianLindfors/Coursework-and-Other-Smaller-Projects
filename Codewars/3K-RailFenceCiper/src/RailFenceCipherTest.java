...
public class RailFenceCipherTest {
    ...
    public void encodeSampleTests() {
        ...
        for (int i=0 ; i<encodes.length ; i++) {
            Assertions.assertEquals(encodes[i][1], RailFenceCipher.encode(encodes[i][0], rails[i]));
        }
    }
    ...
    public void decodeSampleTests() {
        ...
        for (int i=0 ; i<decodes.length ; i++) {
            Assertions.assertEquals(decodes[i][1], RailFenceCipher.decode(decodes[i][0], rails[i]));
        }
    }
